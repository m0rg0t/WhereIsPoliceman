...
(function($, DX, undefined) {
    ...
    var current = function(deviceName) {
            ...
            else if (window.sessionStorage && sessionStorage.getItem("dx-force-device"))
                forceDevice(sessionStorage.getItem("dx-force-device"));
    ...
    ui.registerComponent("dxDatebox", ui.dxEditbox.inherit({
        ...
        _render: function() {
            ...
            this._inputElement = this.rootElement().find("." + EDITBOX_INPUT_CLASS).prop({
                ...
                modelValue = mergeDates(modelValue, value, MODE_FORMAT_MAP[this.option("format")]);
...
(function($, DX, undefined) {
    ...
    ui.registerComponent("dxRangeSlider", ui.dxSlider.inherit({
        ...
        _handleStart: function(args) {
            var e = args.jQueryEvent,
                eventOffsetX = this._eventHelper.eventX(e) - this._bar.offset().left,
                ratio = eventOffsetX / this._bar.width(),
...
(function($, DX, undefined) {
    ...
    ui.registerComponent("dxGalleryNavButton", ui.Widget.inherit({
        ...
        _render: function() {
            this.callBase();
            this.rootElement().addClass(GALLERY_CLASS + "-nav-button-" + this.option("direction"))
        }
    }));
...
(function($, DX, undefined) {
    var ui = DX.ui,
        ...
        navigationManagerregisterCustomBack = null;
    ...
    ui.registerComponent("dxOverlay", ui.ContainerWidget.inherit({
        ...
        show: function() {
            var self = this;
            self.closeCallback = $.proxy(self.hide, self);
            DX.backButtonCallback.add(self.closeCallback);
    ...
    ui.dxOverlay.__internals = {OVERLAY_SHOW_EVENT_TOLERANCE: OVERLAY_SHOW_EVENT_TOLERANCE}
})(jQuery, DevExpress);
    ...
    ui.registerComponent(WIDGET_NAME, ui.dxOverlay.inherit({
        ...
        _renderContent: function() {
            if (this.option("message"))
                this._message = $("<div>").addClass("dx-toast-message").text(this.option("message")).appendTo(this._element);
...
(function($, DX, undefined) {
    ...
    ui.registerComponent("dxLoadPanel", ui.dxOverlay.inherit({
        ...
        _render: function() {
            this.content().addClass(LOADINDICATOR_CONTENT_CLASS);
            this.callBase();
            this.rootElement().addClass(LOADINDICATOR_CLASS);
...
(function($, DX, undefined) {
    ...
    DX.framework.BrowserNavigationDevice = Class.inherit({
        ...
        _createBrowserAdapter: function(options) {
            ...
            if (sessionStorage) {
                var notSupportBrowserHistory = sessionStorage.getItem("dx-not-support-browser-history");
...
(function($, DX) {
    ...
    DX.framework.Application = Class.inherit({
        ctor: function(options) {
            ...
            DX.overlayTargetContainer(".dx-layout");
        ...
        _onNavigating: function(args) {
            var self = this;
            if (args.options.target === "back")
                args.cancel = DX.backButtonCallback.fire();
            if (!args.cancel) {
