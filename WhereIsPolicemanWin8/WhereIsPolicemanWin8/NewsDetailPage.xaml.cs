...
namespace WhereIsPolicemanWin8
{
    ...
    /// </summary>
    public sealed partial class NewsDetailPage : WhereIsPolicemanWin8.Common.LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            try
            {
                ...
                var item = ViewModelLocator.MainStatic.NewsGroup.Items.FirstOrDefault(c => c.Id == (String)navigationParameter);
